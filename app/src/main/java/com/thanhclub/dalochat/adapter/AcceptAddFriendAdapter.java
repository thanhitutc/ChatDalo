...
public class AcceptAddFriendAdapter extends RecyclerView.Adapter<AcceptAddFriendAdapter.AccecptFriendHolder>{
    ...
    public AcceptAddFriendAdapter(ArrayList<UserAddFriend> users){
        this.users = users;
    ...
    @Override
    public AccecptFriendHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.item_request_add_friend, parent, false);
        return new AccecptFriendHolder(view);
    }

    @Override
    public void onBindViewHolder(AccecptFriendHolder holder, final int position) {
        holder.img.setImageResource(R.drawable.chat);
        holder.txtContent.setText(users.get(position).getUsername()+ " đã đồng ý lời mời kết bạn");
    ...
    public class AccecptFriendHolder extends RecyclerView.ViewHolder  {
        private ImageView img;
        private TextView txtContent;

        public AccecptFriendHolder(final View itemView) {
            super(itemView);
